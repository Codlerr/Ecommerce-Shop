...
function footer() {
  return (
    ...
    <section className='bg-black text-white h-full py-10'>
      <div className='w-10/12 mx-auto grid grid-cols-1 md:grid-cols-3 place-items-start '>
        ...
        <div className='grid grid-cols-2 place-items-center place-content-start gap-y-10 h-full w-full'>
              ...
              <div className='w-full h-full grid col-span-2 place-content-center'>
                <div>
